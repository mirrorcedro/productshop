...
const BannerProduct = () => {
    ...
    const mobileImages = [
        image1Mobile, image2Mobile, image3Mobile, image4Mobile, image5Mobile, image6Mobile, image7Mobile, image8Mobile, image9Mobile
    ];
                ...
                <div className='hidden md:flex h-full w-full overflow-hidden'>
                    {desktopImages.map((imageUrl, index) => {
                        return (
                            ...
                            >
                                <img src={imageUrl} className='w-full h-full object-contain' alt={`Banner ${index + 1}`} />
                            </div>
                        );
                    })}
                </div>
